...
image::figures/microprocessor-2.png[align="center",width="50%"]
  ...
  * Improvised model of micropprocessor
...
=== Python's Stack Machine: `BINARY_ADD`

image::figures/py-vm-stack-2.png[align="center",width="45%"]
